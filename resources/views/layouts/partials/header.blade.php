        ...
        <div class="rd-navbar-inner-outer">
          <div class="rd-navbar-inner">
            ...
            <div class="rd-navbar-project-hamburger rd-navbar-project-hamburger-open rd-navbar-fixed-element-1"
              ...
              <span class="fas fa-shopping-cart" style="font-size: 1.3rem"><span
                  style="font-size: 1rem">0</span></span>

            </div>
            <div class="rd-navbar-project">
              <div class="rd-navbar-project-header">
                <h5 class="rd-navbar-project-title">Shop</h5>
                    ...
                    <div class="col-12">
                      ...
                      <table class="table table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <img src="images/product-1-161x162.png" width="40">
                            </td>
                            <td>Product name</td>
                            <td>$0</td>
                            <td>0</td>
                      ...
                      <a href="#" class="button  button-secondary button-winona">Checkout</a>
